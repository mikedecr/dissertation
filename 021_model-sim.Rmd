...
Individual partisans respond to each item probabilistically according to the individual-level item response model originally laid out in Equation&nbsp;\@ref(eq:y-i-irt). The probability $\pi$ that individual $i$ gives a conservative answer to item $j$ is
\begin{align*}
