...
\end{align*} 
Once individual responses are simulated, the number of conservative responses are summed within each item-group and supplied to the group-level response model.
