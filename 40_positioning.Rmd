# Constituent Ideology and Candidate Positioning: Bayesian De-Mediation Model {#ch:positioning}
...
- uncertainty in ML models is a problem
- Bayes gives a straightforward mode for characterizing uncertainty in model parameters (feeding forward into model predictions)
