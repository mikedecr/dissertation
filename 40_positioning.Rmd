...
\begin{split}  
  \E{\text{CF}_{i}\left(\theta, v\right) - 
   ...
   \bar{\theta}_{g} = \theta, X_{d} = x, Z_{d} = z
    ...
    \qquad = \E{\text{CF}_{i} \mid V_{d} = v, \bar{\theta}_{g} = \theta, X_{d} = x, Z_{d} = z} \\
    \qquad \qquad 
...
kable(
  vb_kable,
  caption = "Sample sizes in all estimated models."
)
```
