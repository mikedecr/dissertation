...
The hierarchical scale parameters in the group, state, and region random effects are given $\text{Half-Normal}\left(0, 1\right)$ priors, and regression coefficients are regularized slightly more with $\text{Normal}\left(0, 0.5\right)$ priors.
