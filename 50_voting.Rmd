...
The left-side panel in Figure \@ref(fig:spline-coef-prior) plots a histogram of simulated draws from this prior, which features a spike near zero and characteristically long Cauchy tails.^[
...
The right panel shows `r n_coef_draws` prior predictive draws of the spline functions, resulting from `r n_coef_draws` coefficient vectors drawn from the hierarchical prior.
