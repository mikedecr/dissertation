...
parameters {
  ...
  real<lower = 0> sigma_in_g; // if heteroskedastic: next block & index
...
generated quantities {
  ...
  vector[n_group] theta_std;  // identification with mean and variance?
  theta_std = (theta - mean(theta)) / sd(theta);
