...
- Alex:
    ...
    - BNN is chained logistic-ish regressions
        - Why do they compress the space with that transformation?
        - Why logistic?
        - Is it unidentified in the non-Bayes world as well?
- Barry:
...
- [ ] causal inference: integrate a loss function over a posterior distribution
- [ ] conceptual/term clarity in the beginning
    - who are partisans? 
    - are they primary voters or not necessarily? 
    - What is "district partisanship" and how is it different from partisan ideology?
...
- Ch 4 BART
    - justify BART w/ RMSE in predicting treatment/mediator (also in vs. out)
    - decide if we should do two stages for each analysis

Data:

- [ ] clean/consolidate primary rules data 2016
