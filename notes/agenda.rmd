...
- [ ] ask Alex about identifiability in heteroskedastic model
- [ ] hierarchical prior for items?
    - pool items toward difficulty and discrimination distributions
...
- [ ] difference in errors should be scaled by inv(sigma) also? check CJR
- [ ] more cites in model chapter
  - don't forget Londregon??
