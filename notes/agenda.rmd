...
- Bureaucracy:
    ...
    - [ ] Nadav meeting
- Ask Alex about: 
    - [x] variance of normal/logistic in formal model
    ...
    - [ ] addition of group variance in IRT model with a LOGIT?
- Paper fixes
...
- Code fixes
    - [ ] offline mathjax
    - [x] script to move data from Box?
    - [x] redo bookdown
    - [x] output-specific rendering: <https://bookdown.org/yihui/bookdown/usage.html>
    - [x] graphics device should be f() rendered doctype
    - [ ] if a chapter is rendered in a fresh env, the first thing it caches
