...
- ch 2: 
    ...
    - items and wording
    - post-MCMC graphics
    - compare ideal to CCES self-placement
- write ch 3
...
- ch 5:
    - writing
        - two part contribution: specification and also setup aids interpretation of other things falsely attributed to ideology
        - is Markey more liberal, or the incumbent with lots of other advantages
    - mcmc all models
        - add a constant to spline
    - fix post-estimation code
