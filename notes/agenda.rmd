...
- ch 2: 
    ...
    - revisions:
        ...
        - ANES 2012 and 2014
- write ch 3
    - permit Bayes: flat doesn't imply non-info, non-info doesn't imply flat, priors are relevant for modeling
    - justify Bayes: multi-stage models, p -> n or p > n, one-off data, prior information
    - Rubin: prior for $y$ integrates over treatment assignment, which is random.
- ch 4:
    - revisions:
        - run MCMC on fixed theta
        - send alex data and code
    - variance weighting of ideal points (Is this barry?)
    - explain TPO
    - other Barry comments
- ch 5:
    - writing
        - is Markey more liberal, or the incumbent with lots of other advantages
    ...
    - what about the way presidential voting affects candidate positioning?
        - conditioning on the district
    - revisions:
        - ideal point prior
