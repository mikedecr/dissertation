...
- fix all Ch 5 data... there aren't any fuuUUUcking primary outcomes in 2016!!
- write ch 3
...
- other party ideal point prior (currently mean only)
...
- Grossman/Hopkins
    - I think this means GOP should collapse, and Dems should be "responsive" 
    - especially since we use proxies for social group issue focus as predictors in the IRT model, and groups have particularistic spending for Democrats (cite?)
- Sniderman theory
    - what is the theory?
- Linda Fowler 1982
    - interest group ratings were more differentiated on the end of the spectrum where the group is located, other end is a lump
    - Brunell late 90s
