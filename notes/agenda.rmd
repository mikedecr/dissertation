...
- Meetings:
    ...
    - [ ] Barry
        ...
        - been working on learning predictive modeling tricks
            - two goals: thesis and professional
            - something to improve the fit of the multilevel model, since it's doing a lot.
            - Make myself more attractive to non-academic hirers.
            - The stakes for the latter are really going up because we're careening toward recession.
        - did some reading about choice models for the last chapter
        - need to figure out if the data support continuous vote DV or only binary
        - Achen and Bartels
    - [ ] Devin (see email)
- TOC
    - see Barry email
...
- APW prep
    ...
    - prioritize reading
        - _causal modeling_
            - ABS: sequential-g
            - ABS: causal mechanism treatment arms
            - Bafumi Gelman correlated ranefs/ what are they
            - between v within estimators
            - DAGs for fixed/random effects
        - _covariate selection/other practices_
            - sort through books
            - Justify covariate adjustment w/ _cites
        - _night_: 
            - prior-likelihood
    - naive regressions
    - sequential G
...
- **Bureaucracy**
    - [ ] New table of contents, descriptions of the chapters, circulate to the four
    - [ ] Mike meeting
    - [ ] Nadav meeting
- **Alex**
    - [ ] remembering districts(?) we don't have a lag on the previous district value, only the geographic coefficients
    - [ ] weighting questions:
    ...
    - [x] hierarchical priors for item parameters?
        - CW do *not* do this
        - Alex says: multivariate normal because they'll be correlated
        - This is how we get around incidental parameters?
