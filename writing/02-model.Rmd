...
## Ideal Points and Spatial Models in Political Science

What is the formal model intuition? 


```{r test-theme, include = TRUE, echo = FALSE, cache = FALSE, fig.height = 3, fig.width = 6, out.width = "100%"}
...
## A Heteroskedastic Model of Party-Public Ideology

This section outlines my ideal point model for local partisan groups. First, I lay out the intuition and notation of a basic individual-level IRT model and its connection to the group-level model. I then lay out my hierarchical model of party-public means and its dynamic form. Finally, I discuss model identification and prior distributions.


<!-- ### Static Model -->

### Group-Level IRT Setup

<!-- Start this in a utility framework?
...
- First, using traditional notation. Reparameterization in Section&nbsp;\@ref(stan-features) greatly improves the estimation in Stan.
...
## Model Implementation in Stan {#stan-features}
...
##### Read file into an appendix?


<!-- 
```{r stanfile, code = readLines(here::here("code", "dgirt", "stan", "long", "long-homo-mlm.stan")), include = TRUE, echo = TRUE, eval = FALSE}
```
